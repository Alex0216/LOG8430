...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>File Name Command</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class FileNameCommandImpl extends MinimalEObjectImpl.Container implements FileNameCommand {
	/**
	...
	protected EClass eStaticClass() {
		return TP2Package.Literals.FILE_NAME_COMMAND;
	}
	...
	public void setCommandName(String newCommandName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TP2Package.FILE_NAME_COMMAND__COMMAND_NAME, oldCommandName, commandName));
	}
	...
	public Ressource getRessource() {
		if (ressource != null && ressource.eIsProxy()) {
			...
			if (ressource != oldRessource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TP2Package.FILE_NAME_COMMAND__RESSOURCE, oldRessource, ressource));
			}
		}
		return ressource;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case TP2Package.FILE_NAME_COMMAND___CLEAR:
				clear();
				return null;
			case TP2Package.FILE_NAME_COMMAND___CAN_EXECUTE:
				return canExecute();
			case TP2Package.FILE_NAME_COMMAND___IS_RESSOURCE_SUPPORTED:
				return isRessourceSupported();
			case TP2Package.FILE_NAME_COMMAND___VISIT__FICHIER:
				visit((Fichier)arguments.get(0));
				return null;
			case TP2Package.FILE_NAME_COMMAND___VISIT__DOSSIER:
