 ...
 * <ul>
 *   <li>{@link ca.polymtl.log8430.model.TP2.impl.AbstractCommandImpl#getCommandName <em>Command Name</em>}</li>
 *   <li>{@link ca.polymtl.log8430.model.TP2.impl.AbstractCommandImpl#getRessource <em>Ressource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class AbstractCommandImpl extends MinimalEObjectImpl.Container implements AbstractCommand {
	/**
	...
	protected EClass eStaticClass() {
		return TP2Package.Literals.ABSTRACT_COMMAND;
	}
	...
	public void setCommandName(String newCommandName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TP2Package.ABSTRACT_COMMAND__COMMAND_NAME, oldCommandName, commandName));
	}
	...
	public Ressource getRessource() {
		if (ressource != null && ressource.eIsProxy()) {
			...
			if (ressource != oldRessource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TP2Package.ABSTRACT_COMMAND__RESSOURCE, oldRessource, ressource));
			}
		}
		return ressource;
	}
	...
	public void setRessource(Ressource newRessource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TP2Package.ABSTRACT_COMMAND__RESSOURCE, oldRessource, ressource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TP2Package.ABSTRACT_COMMAND__COMMAND_NAME:
				return getCommandName();
			case TP2Package.ABSTRACT_COMMAND__RESSOURCE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TP2Package.ABSTRACT_COMMAND___EXECUTE:
				execute();
				return null;
			case TP2Package.ABSTRACT_COMMAND___IS_RESSOURCE_SUPPORTED:
				return isRessourceSupported();
			case TP2Package.ABSTRACT_COMMAND___VISIT__FICHIER:
				visit((Fichier)arguments.get(0));
				return null;
			case TP2Package.ABSTRACT_COMMAND___VISIT__DOSSIER:
				visit((Dossier)arguments.get(0));
				return null;
			case TP2Package.ABSTRACT_COMMAND___VISIT__PAGE:
