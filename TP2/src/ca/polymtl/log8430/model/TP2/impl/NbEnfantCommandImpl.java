...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Nb Enfant Command</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link ca.polymtl.log8430.model.TP2.impl.NbEnfantCommandImpl#getCommandName <em>Command Name</em>}</li>
 *   <li>{@link ca.polymtl.log8430.model.TP2.impl.NbEnfantCommandImpl#getResult <em>Result</em>}</li>
 *   <li>{@link ca.polymtl.log8430.model.TP2.impl.NbEnfantCommandImpl#getRessource <em>Ressource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NbEnfantCommandImpl extends MinimalEObjectImpl.Container implements NbEnfantCommand {
	/**
	...
	protected EClass eStaticClass() {
		return TP2Package.Literals.NB_ENFANT_COMMAND;
	}
	...
	public void setCommandName(String newCommandName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TP2Package.NB_ENFANT_COMMAND__COMMAND_NAME, oldCommandName, commandName));
	}
	...
	public void setResult(String newResult) {
		...
		result = newResult;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TP2Package.NB_ENFANT_COMMAND__RESULT, oldResult, result));
	}
	...
	public Ressource getRessource() {
		if (ressource != null && ressource.eIsProxy()) {
			...
			if (ressource != oldRessource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TP2Package.NB_ENFANT_COMMAND__RESSOURCE, oldRessource, ressource));
			}
		}
		return ressource;
	}
	...
	public void setRessource(Ressource newRessource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TP2Package.NB_ENFANT_COMMAND__RESSOURCE, oldRessource, ressource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TP2Package.NB_ENFANT_COMMAND__COMMAND_NAME:
				return getCommandName();
			case TP2Package.NB_ENFANT_COMMAND__RESULT:
				return getResult();
			case TP2Package.NB_ENFANT_COMMAND__RESSOURCE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case TP2Package.NB_ENFANT_COMMAND___CLEAR:
				clear();
				return null;
			case TP2Package.NB_ENFANT_COMMAND___CAN_EXECUTE:
				return canExecute();
			case TP2Package.NB_ENFANT_COMMAND___VISIT__FICHIER:
				visit((Fichier)arguments.get(0));
				return null;
			case TP2Package.NB_ENFANT_COMMAND___VISIT__DOSSIER:
