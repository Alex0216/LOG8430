...
/**
 * This is the item provider adapter for a {@link ca.polymtl.log8430.model.TP2.AbsolutePathCommand} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbsolutePathCommandItemProvider 
	 ...
	 * @generated
	 */
	public AbsolutePathCommandItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns AbsolutePathCommand.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AbsolutePathCommand"));
	}
	...
	public String getText(Object object) {
		String label = ((AbsolutePathCommand)object).getCommandName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbsolutePathCommand_type") :
			getString("_UI_AbsolutePathCommand_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbsolutePathCommand.class)) {
