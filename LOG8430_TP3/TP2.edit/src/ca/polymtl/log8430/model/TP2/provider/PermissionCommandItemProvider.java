...
/**
 * This is the item provider adapter for a {@link ca.polymtl.log8430.model.TP2.PermissionCommand} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PermissionCommandItemProvider 
	 ...
	 * @generated
	 */
	public PermissionCommandItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns PermissionCommand.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PermissionCommand"));
	}
	...
	public String getText(Object object) {
		String label = ((PermissionCommand)object).getCommandName();
		return label == null || label.length() == 0 ?
			getString("_UI_PermissionCommand_type") :
			getString("_UI_PermissionCommand_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PermissionCommand.class)) {
